...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and insect.is_real_queen==True:
                return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        placetp,range_counter=self.place,0
        while not isinstance(placetp, Hive):
            if placetp.bees and range_counter>=self.min_range and range_counter<=self.max_range:
                return random_or_none(placetp.bees)
            placetp=placetp.entrance
            range_counter+=1
        # END Problem 3 and 4
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if self.contained_ant!=None or other.is_container==True:
            return False
        else:
            return True
        # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        Ant.__init__(self, armor)
        if QueenAnt.is_real_queen==False:
            QueenAnt.is_real_queen=True
            self.is_real_queen=True
            self.is_ant_buffed=[]
        else:
            self.is_real_queen=False
        # END Problem 13
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if self.is_real_queen==False:
            self.reduce_armor(self.armor)
        else:
            self.throw_at(self.nearest_bee(colony.beehive))
            exit_path=self.place.exit
            while exit_path:
                if exit_path.ant!=None:
                    if exit_path.ant not in self.is_ant_buffed:
                        exit_path.ant.damage*=2
                        self.is_ant_buffed.append(exit_path.ant)
                    if exit_path.ant.is_container and exit_path.ant.contained_ant!=None and exit_path.ant.contained_ant not in self.is_ant_buffed:
                        exit_path.ant.contained_ant.damage*=2
                        self.is_ant_buffed.append(exit_path.ant.contained_ant)
                exit_path=exit_path.exit
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor<=0 and self.is_real_queen:
            bees_win() 
        elif self.armor<=0 and self.is_real_queen==False:
            self.place.remove_insect(self)
            self.death_callback()
...
def apply_effect(effect, bee, duration):
    ...
    affected=effect(bee.action,bee)
    count=0
